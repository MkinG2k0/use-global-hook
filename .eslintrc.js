module.exports = {
	...
	rules: {
		...
		// 'jsx-quotes': [1, 'prefer-single'], //  Err prettier
		...
		// 'no-magic-numbers': [1], // запретить магические числа , нужно завернуть числа в переменные
		...
		// ! ERROR
		'no-param-reassign': [2], //   запретить переопределение аргуменов функции
